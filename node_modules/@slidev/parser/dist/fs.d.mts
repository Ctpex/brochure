 ...
 */
export declare function isPathInsideRoots(filePath: string, roots: string[]): boolean;
export declare function injectPreparserExtensionLoader(fn: PreparserExtensionLoader): void;
...
export declare function load(options: LoadRootsInfo, filepath: string, sources?: Record<string, string> | ((path: string) => Promise<string>), mode?: string): Promise<LoadedSlidevData>;
export declare function save(markdown: SlidevMarkdown): Promise<string>;
//#endregion
